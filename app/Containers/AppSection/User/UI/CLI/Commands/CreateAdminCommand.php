...
class CreateAdminCommand extends ParentConsoleCommand
{
    ...
    public function handle(): void
    {
        ...
        $last_name = $this->ask('Enter the last_name for this user');
        $first_name = $this->ask('Enter the first_name for this user');
        $middle_name = $this->ask('Enter the middle_name for this user');
